...
for i = 1:iteration
    ...
    if Elevation > 5*pi/180
        ...
        X_prop = [R_sc3 R_v3];
        [~,P,~] = propagate2(R_m3,X_prop,P,t_step,t_sim);
...
%         
        ...
        if count == 10 && C == 1
            ...
            X_prop = [R_sc3 R_v3];
            [~,P,~] = propagate2(R_m3,X_prop,State_covariance,t_step,t_sim);
            ...
            [State_covariance_RAE X_update delRAE del_X KALMAN_GAIN_RAE RC_RAE] = RAE_UPDATE(X_priori_RAE,i*sampt,phi,...%changed time_RAE to i*sampt
                lambda,Z,P,R_rae);
            ...
            X_prop = [R_sc3 R_v3];
            [~,P,~] = propagate2(R_m3,X_prop,State_covariance_RAE,t_step,t_sim);
            ...
            [cov,~,~] = propagate2(Rm,Xp,P1,t_step,i*sampt-2:1:i*sampt);
        ...
        [cov,P,~] = propagate2(Rm,Xp,P,t_step,i*sampt-2:1:i*sampt);
        covariance(i*sampt-1:i*sampt,:) = cov; 
...
error_EKF = X_true(length(X_filter),:) - X_filter;
run EKF_plots