...
figure
stairs(exTime(:,1),P_err(:,1),'-ok')
hold on
stairs(exTime(:,2),P_err(:,2),'--ok')
stairs(exTime(:,3),P_err(:,3),':ok')
stairs(exTime(:,4),P_err(:,4),'-.ok')
set(gca,'FontSize',15,'FontName','Times New Roman')
xlim([0 65])
ylim([5 45])
xlabel('Processing time (ms)','FontSize',15,'FontName','Times New Roman')
...
figure
%subplot(2,1,1)
plot(nos,UKF_PER,'-ok',nos,ESPUKF_PER,'-.ok',nos,SPUKF_PER,':ok',nos,EKF_PER,'--ok','LineWidth',1.5)
set(gca,'FontSize',15,'FontName','Times New Roman')
grid on
xlabel('No. of satellites','FontSize',15,'FontName','Times New Roman')
ylabel('\epsilon/(PDOP\sigma_R)','FontSize',15,'FontName','Times New Roman')
...
ylabel('(\epsilon/\sigma_R)^2','FontSize',15,'FontName','Times New Roman')
legend('EKF','SPUKF','ESPUKF','UKF')
legend boxoff
